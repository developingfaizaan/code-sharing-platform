    ...
    <main className={`w-full max-w-4xl my-20 mx-auto px-5 md:px-12 sm:px-32`}>
      ...
      <aside className="flex justify-between">
        <div className="mt-1 w-96 flex rounded-md border border-black300">
          ...
          <a href="/" className="py-3 px-5 truncate bg-black100 text-sky-400">
            binfn.vercel.app/4nt2oiqirsadfsadf
          </a>

          <button className="justify-self-end inline-flex items-center py-3 px-5 bg-black200 cursor-pointer">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
